...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(W\)} (1,0)
  -- node[pos=0.5,below right]{\(8W\)} (3,1)
  -- node[pos=0.5,above right]{\(54W\)} (2,3)
  -- node[pos=0.5,above left]{\(66A\)} (-1,3)
  -- node[pos=0.5,left]{\(1.9A\)} (-1,1)
  -- node[pos=0.5,below left]{\(A\)} cycle;   
\end{tikzpicture}
