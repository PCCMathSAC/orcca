...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(5.3U\)} (2,0)
  -- node[pos=0.5,below right]{\(Z\)} (3,1)
  -- node[pos=0.5,above right]{\(15U\)} (0,3)
  -- node[pos=0.5,above left]{\(U\)} (-1,3)
  -- node[pos=0.5,left]{\(10Z\)} (-1,1)
  -- node[pos=0.5,below left]{\(4.6Z\)} cycle;   
\end{tikzpicture}
