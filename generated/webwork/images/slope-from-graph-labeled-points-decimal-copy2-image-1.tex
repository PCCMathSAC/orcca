...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:78.2454545454546,samples=2] {(1.1*(x-24.7)+41.1)};
    \addplot[soliddot] coordinates {(24.7,41.1)} node[below right] {\((24.7,41.1)\)};
    \addplot[soliddot] coordinates {(39.7,57.6)} node[above left] {\((39.7,57.6)\)};
  \end{axis}
\end{tikzpicture}
