...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\({\frac{7}{8}}T\)} (2,0)
  -- node[pos=0.5,below right]{\({\frac{2}{5}}I\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{2}{3}}v\)} (2,2)
  -- node[pos=0.5,above left]{\({\frac{4}{5}}I\)} (0,2)
  -- node[pos=0.5,left]{\({\frac{3}{4}}T\)} (-1,1)
  -- node[pos=0.5,below left]{\(v\)} cycle;   
\end{tikzpicture}
