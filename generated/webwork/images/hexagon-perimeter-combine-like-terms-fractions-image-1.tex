...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{6}{7}}c\)} (1,0)
  -- node[pos=0.5,below right]{\({\frac{7}{3}}m\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{5}{2}}j\)} (2,3)
  -- node[pos=0.5,above left]{\({\frac{8}{3}}j\)} (-1,3)
  -- node[pos=0.5,left]{\(m\)} (-1,1)
