...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-3.875*(x-33)+41)};
    \addplot[soliddot] coordinates {(33,41)} node[above right] {\((33,41)\)};
    \addplot[soliddot] coordinates {(41,10)} node[below left] {\((41,10)\)};
  \end{axis}
\end{tikzpicture}
