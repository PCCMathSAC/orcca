...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(0.384615*(x-41)+71)};
    \addplot[soliddot] coordinates {(41,71)} node[above left] {\((41,71)\)};
    \addplot[soliddot] coordinates {(15,61)} node[below right] {\((15,61)\)};
  \end{axis}
\end{tikzpicture}
