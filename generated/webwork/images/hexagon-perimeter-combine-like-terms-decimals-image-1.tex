...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(43R\)} (2,0)
  -- node[pos=0.5,below right]{\(R\)} (3,1)
  -- node[pos=0.5,above right]{\(U\)} (2,2)
  -- node[pos=0.5,above left]{\(38U\)} (0,2)
  -- node[pos=0.5,left]{\(R\)} (-1,1)
  -- node[pos=0.5,below left]{\(55U\)} cycle;   
\end{tikzpicture}
