...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(-13/31):(312/31)]{(62*(x-6)+348)};
    \addplot[soliddot] coordinates {(6,348)} node[below right] {\((6,348)\)};
    \addplot[soliddot] coordinates {(2,100)} node[below right] {\((2,100)\)};
  \end{axis}
\end{tikzpicture}
