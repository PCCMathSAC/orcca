...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{1}{8}}S\)} (1,0)
  -- node[pos=0.5,below right]{\({\frac{8}{7}}h\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{10}{7}}h\)} (2,3)
  -- node[pos=0.5,above left]{\({\frac{5}{3}}H\)} (-1,3)
  -- node[pos=0.5,left]{\({\frac{4}{5}}S\)} (-1,1)
  -- node[pos=0.5,below left]{\({\frac{2}{3}}H\)} cycle;   
\end{tikzpicture}
