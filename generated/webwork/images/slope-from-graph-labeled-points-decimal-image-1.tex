...
\begin{tikzpicture}
  \begin{axis}[
      ...
      ytick=,
      minor ytick=,
      width=0.33\orccaprintwidth,
      clip=false
    ]
    \addplot+[-,domain=26.6230769230769:100,samples=2] {(0.886364*(x-49.3)+10.1)};
    \addplot[soliddot] coordinates {(49.3,10.1)} node[below right] {\((49.3,10.1)\)};
    \addplot[soliddot] coordinates {(62.5,21.8)} node[above left] {\((62.5,21.8)\)};
  \end{axis}
\end{tikzpicture}
