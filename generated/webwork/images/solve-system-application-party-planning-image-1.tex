...
\begin{document}
\begin{tikzpicture}
\begin{axis}[xmin=-5,xmax=70,ymin=-5,ymax=80,xtick={-100,-95,...,100},ytick={-100,-95,...,100},minor xtick={-100,-99,...,100},minor ytick={-100,-99,...,100}]
\addplot[firstcurve,-,domain=-5:70]{((140-2.5*x)/1.75)};
\addplot[secondcurve,-,domain=-5:70]{(68-x)};
\end{axis}
\end{tikzpicture}
