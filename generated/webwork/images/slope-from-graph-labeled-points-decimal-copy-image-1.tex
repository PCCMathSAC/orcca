...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:74.0012048192771,samples=2] {(1.21463*(x-57.7)+80.2)};
    \addplot[soliddot] coordinates {(57.7,80.2)} node[above left] {\((57.7,80.2)\)};
    \addplot[soliddot] coordinates {(37.2,55.3)} node[below right] {\((37.2,55.3)\)};
  \end{axis}
\end{tikzpicture}
