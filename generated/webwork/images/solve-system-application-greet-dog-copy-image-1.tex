...
\begin{document}
\begin{tikzpicture}
\begin{axis}[xmin=0,xmax=12,ymin=0,ymax=300,xtick={0,4,8,12},ytick={0,50,...,100},minor xtick={0,1,...,12},minor ytick={0,10,...,100},xlabel={\(t\)},ylabel={\(d\)}]
\addplot[firstcurve,-{Kite},domain=0:12]{(3*x)};
\addplot[secondcurve,-{Kite},domain=0:12]{(65+(-10)*x)};
\end{axis}
\end{tikzpicture}
