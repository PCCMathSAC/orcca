...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:11]{((93/7)*(x-9)+345)};
    \addplot[soliddot] coordinates {(9,345)} node[below right] {\((9,345)\)};
    \addplot[soliddot] coordinates {(2,252)} node[below right] {\((2,252)\)};
  \end{axis}
\end{tikzpicture}
