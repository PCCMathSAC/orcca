...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:(1239/134)]{((134/3)*(x-9)+589)};
    \addplot[soliddot] coordinates {(9,589)} node[below right] {\((9,589)\)};
    \addplot[soliddot] coordinates {(3,321)} node[below right] {\((3,321)\)};
  \end{axis}
\end{tikzpicture}
