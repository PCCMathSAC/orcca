...
\begin{document}
\begin{tikzpicture}
\begin{axis}[xmin=-5,xmax=30,ymin=-20,ymax=10,xtick={-100,-95,...,100},ytick={-100,-95,...,100},minor xtick={-100,-99,...,100},minor ytick={-100,-99,...,100}]
\addplot[firstcurve,-,domain=-5:30]{((28-x)/4)};
\addplot[secondcurve,-,domain=-5:30]{(x-18)};
\end{axis}
\end{tikzpicture}
