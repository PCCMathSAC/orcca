...
\begin{tikzpicture}
    \begin{axis}[numberline,
                xmin=0,xmax=1,
                xtick={0,1},
                minor xtick={-2,-1.8571428,...,2},
                extra x ticks={0.42857},
                extra x tick labels={$\frac{3}{7}$},
                xlabel={},
                ]
        \addplot[firstcurve, -, smooth] coordinates {(0,0) (0.071428,1) (0.142857,0)};
        \addplot[firstcurve, -, smooth] coordinates {(0.142857,0) (0.214228,1) (0.285714,0)};
        \addplot[firstcurve,->, smooth] coordinates {(0.285714,0) (0.35714,1) (0.42857,0)};
    \end{axis}
\end{tikzpicture}
}
\end{document}
